...
from fi_game.lexicon import DEFAULT_YAML_PATH, YamlLexiconStore, resolve_repo_path


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Count YAML entries by part of speech.")
    parser.add_argument(
        "yaml_path",
        nargs="?",
...
def main() -> int:
    ...
    counts = YamlLexiconStore(yaml_path).count_by_pos()
